---
title: Get Started!
abstract: Get to know us through this portfolio.
date: '2023-08-08'
banner: /static/modern-react-css-banner.jpg
featured: true
---

Do Your Own Website easily with WeDev.

**Website Design & Development:**

1. **Website Development:** We adopt fully Agile/Scrum methodology for our web design and development process. This allows us to quickly adapt to change of requirement and promptly deliver business value to website users. During the website design and development process, client always stays updated with the actual progress and collaborate with the team to respond to the feedbacks from end users.
2. **UX/UI Design:** Great user experience design not only highlights and promotes your product, but it also has become a key part of building and growing customer confidence.
3. **Quality Assurance:** The quality assurance process starts at very early stage where we conduct inspection throughout the plan, written requirement document, software design document, etc. and go through to deployment phase when the website is deployed on live environment.
4. **Maintainance & Support :** We provide one year free-of-charge support for handling any programming problem from the live environment system. Our client will also benefit from the prompt response and support of the team with the plan of 24 hours feedback. With a small subscription to system operation service, client can free hands from daily activities such as system monitoring, backup and restore, failure recovering, etc. It defines our end-to-end web design and development service.

**Mobile App Development:**

1. **MOBILE APPLICATIONS AND DEVICE PLATFORMS:** We offer a full-stack Website development, including tailoring a public platform chain with protocols that fit your needs.
2. **FRONT-END DEVELOPMENT:** We ensure to thoroughly understand the client's requirements and offer a suitable technical platform.
3. **BACK-END DEVELOPMENT:** We guarantee the product for the time specified in the contract to bring the best user experience.
4. **PRODUCT TESTING & REVIEWING:** We make a complete delivery of work done based on assignments with testing and reviewing.
